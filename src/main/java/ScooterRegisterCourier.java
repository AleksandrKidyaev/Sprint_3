...
/*
Код полностью скопирован из условия проекта в тренажере
Не знал можно ли его редактировать для своих нужд или нет, поэтому оставил так
и сделал на него один тест на всякий случай.
В условии к проекту не указано, что использовать именно этот метод
для создания нового пользователя обязательно, поэтому я создал свой класс для этого
Для конкретных заданий из условий проекта рандомизация в данном случае мне кажется избыточной,
ввиду того, что после каждого теста созданный курьер и так удаляется
*/
